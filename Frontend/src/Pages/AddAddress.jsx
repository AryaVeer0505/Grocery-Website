...
const InputField = ({ type, placeholder, name, handleChange, address }) => (
  <input
    className="w-full px-2 py-2.5 border border-gray-500/10 rounded outline-0 text-gray-500 focus:border-green-500 transition"
    type={type}
  ...
  return (
    <div className="mt-16 pb-16">
      <p className="text-2xl md:text-3xl text-gray-500">
        Add Shipping{" "}
        <span className="text-green-500 font-semibold">Address</span>
      </p>
          ...
          <div className="flex-1 max-w-md">
              <form onSubmit={onSubmitHandler} className="space-y-3 mt-6 text-sm">
                ...
                <div className="grid grid-cols-2 gap-4">
                   ...
                   <button className="w-full mt-6 bg-green-500 text-white py-3 hover:bg-green-400 transition cursor-pointer uppercase" >Save Address</button>
              </form>
          </div>
