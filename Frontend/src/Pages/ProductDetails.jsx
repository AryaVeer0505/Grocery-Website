    ...
    return product && (
        <div className="mt-16">
            <p>
                ...
                <Link className="text-green-500"> {product.name}</Link>
            </p>
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-green-500 hover:bg-green-400 hover:text-white transition">
                    See More
                </button>
            </div>
        </div>
