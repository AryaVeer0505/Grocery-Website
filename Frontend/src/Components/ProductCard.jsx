            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                            ...
                            <img key={i} src={i<4?assets.star_icon:assets.star_dull_icon} className="md:w-3.5 w-3"/>
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=>{e.stopPropagation()}} className="text-green-500">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-green-100 border border-green-300 md:w-[80px] w-[64px] h-[34px] rounded text-green-600 font-medium cursor-pointer" onClick={()=>{
